...
-- Safe to re-run because existing database objects are recreated.
...
-- Adds a GiST index for geography-based distance queries, avoiding
-- full-table scans and significantly improving exposure query performance.
