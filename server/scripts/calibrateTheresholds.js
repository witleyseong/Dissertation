// Samples random walking segments using the real exposure filters to calibrate
// crime-density thresholds. Re-run after changing the crime data range or area.
...
// Same bounding box import.sh filters crimes into (Zones 1-2 + margin).
